...
from farmbetter_client.context import UserContext
from farmbetter_client.models import (
    GqTimelineEntryInput,
    GqUserLocationInput,
    OmittedUpdateUserRequest,
)
from farmbetter_client.problems import create_reported_problem
from farmbetter_client.users import update_user
from google.adk.tools import ToolContext
from loguru import logger
from pydantic import BaseModel, Field

from farmwise.config import config
...
async def record_problem(
    ...
    created_problem = await create_reported_problem(
        ...
        timeline=[
            ...
            GqTimelineEntryInput(
                from_=config.FARMBETTER_ASSISTANT_USER_ID,
