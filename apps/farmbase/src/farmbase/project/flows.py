# from farmbase.case.enums import CostModelType
# from farmbase.case.priority import service as case_priority_service
# from farmbase.case.priority.config import default_case_priorities
# from farmbase.case.priority.models import CasePriorityCreate
# from farmbase.case.severity import service as case_severity_service
# from farmbase.case.severity.config import default_case_severities
# from farmbase.case.severity.models import CaseSeverityCreate
# from farmbase.case.type import service as case_type_service
# from farmbase.case.type.config import default_case_type
# from farmbase.case.type.models import CaseTypeCreate
# from farmbase.case_cost_type import service as case_cost_type_service
# from farmbase.decorators import background_task
# from farmbase.incident.priority import service as incident_priority_service
# from farmbase.incident.priority.config import default_incident_priorities
# from farmbase.incident.priority.models import IncidentPriorityCreate
# from farmbase.incident.severity import service as incident_severity_service
# from farmbase.incident.severity.config import default_incident_severities
# from farmbase.incident.severity.models import IncidentSeverityCreate
# from farmbase.incident.type import service as incident_type_service
# from farmbase.incident.type.config import default_incident_type
# from farmbase.incident.type.models import IncidentTypeCreate
# from farmbase.incident_cost_type import service as incident_cost_type_service
# from farmbase.incident_cost_type.config import default_incident_cost_type
# from farmbase.incident_cost_type.models import IncidentCostTypeCreate
# from farmbase.plugin import service as plugin_service
# from farmbase.plugin.models import PluginInstanceCreate
...
async def project_init_flow(*, project_id: int, organization_slug: str, db_session=None):
    ...
    #     plugin_instance_in = PluginInstanceCreate(project=project, plugin=plugin, configuration={}, enabled=False)
    ...
    #     project=project,
    # )
    # incident_type = incident_type_service.create(db_session=db_session, incident_type_in=incident_type_in)
    #
    ...
    #     )
    #     incident_priority_service.create(db_session=db_session, incident_priority_in=incident_priority_in)
    #
    ...
    #     )
    #     incident_severity_service.create(db_session=db_session, incident_severity_in=incident_severity_in)
    #
    ...
    #     project=project,
    # )
    # incident_cost_type_service.create(db_session=db_session, incident_cost_type_in=incident_cost_type_in)
    #
