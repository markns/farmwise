...
FARMBASE_AUTHENTICATION_PROVIDER_SLUG = config(
    "FARMBASE_AUTHENTICATION_PROVIDER_SLUG", default="farmbase-auth-provider-basic"
)
...
SQLALCHEMY_DATABASE_URI = f"postgresql+psycopg2://{DATABASE_USER}:{_QUOTED_DATABASE_PASSWORD}@{DATABASE_HOSTNAME}:{DATABASE_PORT}/{DATABASE_NAME}"
