...
def sync_detailed(
    *,
    ...
    """Login
     ...
     Use this endpoint to generate a JWT token that you can use in
    the authorization headers for other requests.
    ...
    The token expires after 1 hour. Call this endpoint again to get a new
    token.
