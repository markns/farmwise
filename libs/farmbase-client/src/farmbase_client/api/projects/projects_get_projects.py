...
from ...models import ErrorResponse, HTTPValidationError, ProjectPagination
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProjectPagination.model_validate(response.json())
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponse, HTTPValidationError, ProjectPagination]
    """
