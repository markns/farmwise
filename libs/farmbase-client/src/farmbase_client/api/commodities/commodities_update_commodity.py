...
from ...models import CommodityUpdate
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/commodities/{commodity_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        commodity_id (int):
        body (CommodityUpdate): Model for updating an existing commodity.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CommodityRead, ErrorResponse, HTTPValidationError]
    """
