...
def _get_kwargs(
    *,
    ...
    json_price_within_days: Union[None, Unset, int]
    if isinstance(price_within_days, Unset):
        json_price_within_days = UNSET
    else:
        json_price_within_days = price_within_days
    params["price_within_days"] = json_price_within_days
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        price_within_days (Union[None, Unset, int]):
