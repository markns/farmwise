...
from ...models import ContactPatch, ContactRead, ErrorResponse, HTTPValidationError
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/{organization}/contacts/{contact_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        organization (str):
        contact_id (int):
        body (ContactPatch): Model for updating existing Contact.
