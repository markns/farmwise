...
) -> Optional[Union[ErrorResponse, HTTPValidationError, list["MessageRead"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponse, HTTPValidationError, list["MessageRead"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponse, HTTPValidationError, list['MessageRead']]
    """
