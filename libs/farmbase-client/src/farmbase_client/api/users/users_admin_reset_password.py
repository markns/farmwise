...
from ...models import AdminPasswordReset, ErrorResponse, HTTPValidationError, UserRead
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/{organization}/users/{user_id}/reset-password".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        organization (str):
        user_id (int):
        body (AdminPasswordReset): Model for admin password resets
