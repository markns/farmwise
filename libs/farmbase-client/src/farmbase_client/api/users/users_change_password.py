...
from ...models import ErrorResponse, HTTPValidationError, UserPasswordUpdate, UserRead
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/{organization}/users/{user_id}/change-password".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        organization (str):
        user_id (int):
        body (UserPasswordUpdate): Model for password updates only
