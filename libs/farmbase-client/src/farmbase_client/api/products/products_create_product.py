...
from ...models import ErrorResponse, HTTPValidationError, ProductCreate, ProductRead
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        organization (str):
        body (ProductCreate): Schema for creating a new product.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponse, HTTPValidationError, ProductRead]
    """
