...
from ...models import SubscriptionPagination
...
) -> Optional[Union[RequestValidationError, SubscriptionPagination]]:
    if response.status_code == 200:
        response_200 = SubscriptionPagination.model_validate(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[RequestValidationError, SubscriptionPagination]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[RequestValidationError, SubscriptionPagination]
    """
