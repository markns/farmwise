...
def _get_kwargs(
    *,
    ...
    json_importance: Union[None, Unset, int]
...
def sync_detailed(
    *,
    ...
    Args:
        event_category (Union[EventCategory, None, Unset]): Filter by event category
        crop_id (Union[None, Unset, str]): Filter by crop
        importance (Union[None, Unset, int]): Filter by importance level
