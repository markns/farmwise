...
) -> Optional[Union[ErrorResponse, HTTPValidationError, list["EventRead"]]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponse, HTTPValidationError, list["EventRead"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponse, HTTPValidationError, list['EventRead']]
    """
