...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/{organization}/farms/contacts/{farm_contact_id}".format(
            organization=organization,
            farm_contact_id=farm_contact_id,
        ),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        organization (str):
        farm_contact_id (int):
        body (FarmContactUpdate): Model for updating an existing FarmContact.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ErrorResponse, FarmContactRead, HTTPValidationError]
    """
