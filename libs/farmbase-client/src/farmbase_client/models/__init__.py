...
#   timestamp: 2025-06-28T04:15:37+00:00
...
class MessageUpdate(BaseModel):
    status: str | None = Field(None, description='Message status', title='Status')
...
class MessageCreate(BaseModel):
    messaging_product: str = Field(
        'whatsapp',
        description="Messaging product (always 'whatsapp')",
        title='Messaging Product',
    )
    recipient_type: RecipientType = Field('individual', description='Recipient type')
    to: str = Field(..., description="Recipient's phone number", title='To')
    type: MessageType = Field('text', description='Message type')
    status: str | None = Field(None, description='Message status', title='Status')
    biz_opaque_callback_data: constr(max_length=512) | None = Field(
        None, description='Business callback data', title='Biz Opaque Callback Data'
    )
    audio: dict[str, Any] | None = Field(
        None, description='Audio message data', title='Audio'
    )
    contacts: dict[str, Any] | None = Field(
        None, description='Contact message data', title='Contacts'
    )
    context: dict[str, Any] | None = Field(
        None, description='Context for message replies', title='Context'
    )
    document: dict[str, Any] | None = Field(
        None, description='Document message data', title='Document'
    )
    image: dict[str, Any] | None = Field(
        None, description='Image message data', title='Image'
    )
    interactive: dict[str, Any] | None = Field(
        None, description='Interactive message data', title='Interactive'
    )
    location: dict[str, Any] | None = Field(
        None, description='Location message data', title='Location'
    )
    sticker: dict[str, Any] | None = Field(
        None, description='Sticker message data', title='Sticker'
    )
    template: dict[str, Any] | None = Field(
        None, description='Template message data', title='Template'
    )
    text: dict[str, Any] | None = Field(
        None, description='Text message data', title='Text'
    )
    reaction: dict[str, Any] | None = Field(
        None, description='Reaction message data', title='Reaction'
    )
    contact_id: int = Field(
        ..., description='ID of the contact to send message to', title='Contact Id'
    )
