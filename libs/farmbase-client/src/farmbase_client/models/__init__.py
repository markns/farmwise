...
#   timestamp: 2025-07-02T08:37:51+00:00
...
class ContactConsentCreate(BaseModel):
    consent_type: str = Field(
        ...,
        description="Type of consent (e.g., 'data_processing', 'marketing', 'communication')",
        title='Consent Type',
    )
    consent_given: bool = Field(
        ..., description='Whether consent was given or not', title='Consent Given'
    )
    consent_version: str = Field(
        ..., description='Version of the consent terms', title='Consent Version'
    )


class ContactConsentRead(BaseModel):
    consent_type: str = Field(
        ...,
        description="Type of consent (e.g., 'data_processing', 'marketing', 'communication')",
        title='Consent Type',
    ...
    id: conint(lt=2147483647, gt=0) | None = Field(
        None, description='Unique identifier of the consent record', title='Id'
    )
    contact_id: int = Field(
        ..., description='ID of the contact this consent belongs to', title='Contact Id'
    )
...
class SubscriptionCreate(BaseModel):
    ...
    topic_id: int = Field(..., description='ID of the topic', title='Topic Id')
    status: str = Field(
        'active', description='Status of the subscription', title='Status'
    )


class SubscriptionUpdate(BaseModel):
    status: str | None = Field(
        None, description='Status of the subscription', title='Status'
    )
...
class TopicCreate(BaseModel):
    name: str = Field(..., description='Name of the topic', title='Name')
    description: str | None = Field(
        None, description='Description of the topic', title='Description'
    )
...
class TopicRead(BaseModel):
    ...
    id: conint(lt=2147483647, gt=0) | None = Field(
        None, description='Unique identifier of the topic', title='Id'
    )


class TopicUpdate(BaseModel):
    name: str | None = Field(None, description='Name of the topic', title='Name')
    description: str | None = Field(
        None, description='Description of the topic', title='Description'
    )
...
class MessageCreate(BaseModel):
    ...
    direction: MessageDirection = Field(
        ..., description='Is the message inbound or outbound'
    )
    ...
    storage: dict[str, Any] | None = Field(
        None, description='Location of downloaded media', title='Storage'
    )
...
class MessageRead(BaseModel):
    ...
    metadata_: dict[str, Any] | None = Field(None, title='Metadata')
...
class MessageSummary(BaseModel):
    ...
    storage_url: str | None = Field(
        None, description='URL of downloaded media file', title='Storage Url'
    )
...
class SubscriptionRead(BaseModel):
    ...
    status: str = Field(
        'active',
        description='Status of the subscription (active, unsubscribed)',
        title='Status',
    )
    contact_id: int = Field(..., description='ID of the contact', title='Contact Id')
    topic_id: int = Field(..., description='ID of the topic', title='Topic Id')
...
class TopicPagination(BaseModel):
    items_per_page: int = Field(..., title='Items Per Page')
    page: int = Field(..., title='Page')
    total: int = Field(..., title='Total')
    items: list[TopicRead] | None = Field(
        None, description='List of topics in the current page', title='Items'
    )
...
class ContactSubscriptionRead(BaseModel):
    contact_id: int = Field(..., description='ID of the contact', title='Contact Id')
    subscriptions: list[SubscriptionRead] = Field(
        ..., description='List of subscriptions for the contact', title='Subscriptions'
    )
...
class SubscriptionPagination(BaseModel):
    items_per_page: int = Field(..., title='Items Per Page')
    page: int = Field(..., title='Page')
    total: int = Field(..., title='Total')
    items: list[SubscriptionRead] | None = Field(
        None, description='List of subscriptions in the current page', title='Items'
    )
