...
) -> Optional[Union[CropVarietiesResponse, RequestValidationError]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CropVarietiesResponse, RequestValidationError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CropVarietiesResponse, RequestValidationError]
    """
